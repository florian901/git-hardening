...
- Replaced the **Gemini CLI** safety-review hint with the **Antigravity CLI** (`agy -p`), and brought the README in line with current behavior (hook dispatch stubs, secret inventory, agent-aware signing, accurate test counts)
...
- `readonly VERSION` bumped to `1.0.0`
